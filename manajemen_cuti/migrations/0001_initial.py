    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lampiran', models.FileField(blank=True, null=True, upload_to=manajemen_cuti.models.lampiran_cuti_path, verbose_name='Dokumen Pendukung')),
                ...
                ('surat_cuti_final', models.FileField(blank=True, null=True, upload_to=manajemen_cuti.models.surat_final_path, verbose_name='Surat Cuti Final')),
                ...
                ('satuan_kerja', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pengajuan_cuti', to='accounts.satker', verbose_name='Satuan Kerja')),
            ],
            options={
