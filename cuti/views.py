...
class LeaveRequestCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'cuti/pengajuan_form.html'
    success_url = reverse_lazy('cuti:riwayat')
...
class LeaveHistoryListView(LoginRequiredMixin, ListView):
    model = PengajuanCuti
    template_name = 'cuti/riwayat_list.html'
...
class LeaveDetailView(LoginRequiredMixin, DetailView):
    model = PengajuanCuti
    template_name = 'cuti/pengajuan_detail.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.user.role not in ('pimpinan', 'superadmin'):
            ...
            return redirect('cuti:detail', pk=cuti.pk)
...
class LeaveAdminListView(LoginRequiredMixin, ListView):
    model = PengajuanCuti
    template_name = 'cuti/admin_list.html'
    context_object_name = 'pengajuan_list'
    paginate_by = 15
