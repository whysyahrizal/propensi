    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disetujui_oleh', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cuti_persetujuan', to=settings.AUTH_USER_MODEL, verbose_name='Diputuskan Oleh')),
                ('personel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cuti_pengajuan', to=settings.AUTH_USER_MODEL, verbose_name='Personel')),
            ],
            options={
